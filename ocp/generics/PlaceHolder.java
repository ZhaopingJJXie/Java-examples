 ...
 public class PlaceHolder<K, V> {
   ...
   public static <X> PlaceHolder<X, X> getDuplicateHolder(X x){
     ...
     public static void main(String[] args) {
       ...
       PlaceHolder<String, String> ph3 = PlaceHolder<String, String>.getDuplicateHolder("b"); //compilation error
       // PlaceHolder<> ph4 = new PlaceHolder<String, String>("a", "b"); //4
       // PlaceHolder<?, ?> ph5 = new PlaceHolder(10, 10); //fine. but with warinings
